...
umount /nfsroot
echo "Rerooting from nfs:10.0.2.2:/home/zyy/sigcheri/cheri/output/rootfs-riscv64-purecap"
kenv "vfs.root.mountfrom=nfs:10.0.2.2:/home/zyy/sigcheri/cheri/output/rootfs-riscv64-purecap" && reboot -r
